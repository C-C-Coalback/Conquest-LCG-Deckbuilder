...
from .SetData import warlord_cycle_warpacks, confrontation_cycle_warpacks, death_world_cycle_warpacks,\
    planetfall_cycle_warpacks, navida_prime_cycle_warpacks, bloodied_path_cycle_warpacks, deluxe_expansions
...
class Card:
    def __init__(self, name, text, traits, cost, faction, loyalty, shields, card_type, unique, image_name="",
        ...
        if self.check_for_a_trait("Pledge."):
            preparation = True
