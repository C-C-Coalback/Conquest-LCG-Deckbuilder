    ...
    chaos_card_array = [
        CardClasses.WarlordCard("Zarathur, High Sorcerer",
                                ...
                                ['1x Mark of Chaos', '1x Shrine of Warpflame',
                                 '2x Infernal Gateway', "4x Zarathur's Flamers"], cycle_info="Core Set"),
        CardClasses.ArmyCard("Zarathur's Flamers", "Action: Sacrifice this unit to deal 2 "
                             ...
                             2, 2, 1, False, action_in_play=True, allowed_phases_in_play="ALL", cycle_info="Core Set"),
        ...
        CardClasses.AttachmentCard("Medallion of Betrayal", "Attach to a non-warlord unit.\n"
                                                            ...
                                                            "is a Cultist.\n"
                                                            "Reaction: After this card enters your discard pile, if "
        ...
        CardClasses.WarlordCard("Tras the Corrupter", "Forced Reaction: After you commit your warlord, replace a "
                                                      ...
                                                      "it again with the original.", "Chosen. Tzeentch.",
                                faction, 2, 6, 2, 5,
                                "Bloodied.\n"
                                "Forced Reaction: After you commit your warlord, replace a "
                                "planet with one from The Breach sector (each planet can "
                                "only be used once). After that planet is captured, replace "
        ...
        CardClasses.WarlordCard("Vael the Gifted", "Effects of events you play cannot be cancelled.\n"
                                                   ...
                                                   "the game.\n"
                                                   "You may play Ritual events you removed from the game as if they "
                                                   "were in your hand. (Limit once per round.)",
        ...
        CardClasses.AttachmentCard("Talisman of Denial", "Attach to your warlord.\n"
                                                         ...
                                                         "damage on your warlord with the damage on a hale warlord "
